...
class DemoGUI:
    ...
    def __init__(self):
        ...
        self.num_records_text.set("Count: 0")            
        ...
        # Show console.
        self.console_box = Text(self.TAB2, bg ="#fff")
